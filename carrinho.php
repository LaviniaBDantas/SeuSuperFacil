                    ...
                    <form class="needs-validation" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="cpf" placeholder="Ex: 123.456.789-10" value=""
                                    required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="tel" placeholder="Ex: (62)99999-9999" value=""
                                    required>
                                <div class="invalid-feedback">
                        ...
                        <div class="row g-3 w-10">
                            ...
                            <div class="col-md-3">
                                ...
                                <input id="numero" name="numEnd" type="radio" class="form-check-input" checked required>
                                <label class="form-check-label" for="numero">Sem número</label>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="invalid-feedback">
                                    Por favor insira um páis válido.
                                </div>
                            </div>
                        ...
                        <button class="w-100 btn btn-success btn-lg" type="submit">Concluir pagamento</button>
                    </form>
                </div>
            </div>
        </main>
